            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form
                            action="{{ isset($subject) ? route('subject.update', encrypt($subject->id)) : route('subject.store') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="name" placeholder="Enter subject name"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('type') is-invalid @enderror"
                                                name="type" id="type">
                                                <option value="theory"
                                                    {{ old('type', $subject->type ?? 'theory') == 'theory' ? 'selected' : '' }}>
                                                    Theory</option>
                                            ...
                                            <div class="mt-2">
                                                <div class="custom-control custom-radio d-inline mr-3">
                                                    <input
                                                        ...
                                                        {{ old('status', $subject->status ?? 1) == 1 ? 'checked' : '' }}>
                                                ...
                                                <div class="custom-control custom-radio d-inline">
                                                    <input
                                                        ...
                                                        {{ old('status', $subject->status ?? 1) == 0 ? 'checked' : '' }}>
                            ...
                            <div class="card-footer text-right">
                                ...
                                <button type="submit"
                                    class="btn btn-primary">{{ isset($subject) ? 'Update' : 'Submit' }}</button>
                            </div>
                        </form>
                    </div>
                </div>
